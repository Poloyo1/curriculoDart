...
;
  ...
  (function staticFields() {
    ...
    $.secoes = A._setArrayType(["[1] > Objetivo Profissional: [Enter para continuar]", "[2] > Busco minha primeira oportunidade no mercado de trabalho para desenvolver minhas habilidades e contribuir com os objetivos da empresa como aprendiz, estagi\xe1rio ou banco de talentos.  [Enter para continuar]", "[3] > Forma\xe7\xe3o Acad\xeamica: [Enter para continuar]", "[4] > FATEC  Curso: An\xe1lise e desenvolvimento de sistemas Em andamento  [Enter para continuar]", "[5] > ETEC Curso: Ensino m\xe9dio / Desenvolvimento de sistemas AMS Ano de conclus\xe3o: 2024  [Enter para continuar]", "[6] > Habilidades: [Enter para continuar]", "[7] > Comunica\xe7\xe3o; Trabalho em equipe;  Organiza\xe7\xe3o; L\xf3gica de programa\xe7\xe3o; PHP, SQL, Python; Pacotes Microsoft (WORD, EXCEL, POWER POINT). [Enter para continuar]"], type$.JSArray_String);
    $.indexAtual = 0;
    $.cursorAtual = null;
  })();
