...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _EventStreamSubscription$(_target, _eventType, onData, _useCapture, $T) {
      ...
      if (t1 != null)
        B.Window_methods._addEventListener$3(_target, _eventType, type$.nullable_dynamic_Function_Event._as(t1), false);
    ...
    main() {
      var terminal = document.querySelector("#terminal"),
        t1 = window;
      t1.toString;
      A._EventStreamSubscription$(t1, "keydown", type$.nullable_void_Function_KeyboardEvent._as(new A.main_closure(terminal)), false, type$.KeyboardEvent);
    },
    _digitarTexto(texto, destino) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t3, t4, i, t5, cursor, list, t1, t2;
      var $async$_digitarTexto = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2.toString;
              destino.appendChild(t2).toString;
              t3 = texto.length, t4 = type$.dynamic, i = 0;
            case 2:
              // for condition
              if (!(i < t3)) {
                // goto after for
              ...
              t5 = t2.textContent;
              t5.toString;
              B.ParagraphElement_methods.set$text(t2, t5 + texto[i]);
              $async$goto = 5;
              return A._asyncAwait(A.Future_Future$delayed(new A.Duration(40000), t4), $async$_digitarTexto);
            case 5:
            ...
            case 4:
              // after for
              cursor = t1.createElement("span");
              list = cursor.classList;
              list.contains("cursor").toString;
              list.add("cursor");
              B.SpanElement_methods.set$text(cursor, "|");
              t2.appendChild(cursor).toString;
              $.cursorAtual = type$.nullable_DivElement._as(cursor);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$_digitarTexto, $async$completer);
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      var t1, t2;
      if (type$.KeyboardEvent._as(e).key === "Enter") {
        t1 = $.indexAtual;
        if (t1 < 7) {
          $.cursorAtual = null;
          t1 = $.secoes[t1];
          t2 = this.terminal;
          t2.toString;
          A._digitarTexto(t1, t2);
          $.indexAtual = $.indexAtual + 1;
        } else {
          t1 = this.terminal;
          t1.toString;
          A._digitarTexto("> Fim do curr\xedculo.", t1);
        }
      }
    },
    $signature: 13
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.DomTokenList, A.Event]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.DivElement, A.FormElement, A.ParagraphElement, A.SelectElement, A.SpanElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(@)", "~(~())", "Null()", "Null(Object,StackTrace)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "~(Event)", "~(KeyboardEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"KeyboardEvent":{"Event":[]},"HtmlElement":{"EventTarget":[]},"AnchorElement":{"EventTarget":[]},"AreaElement":{"EventTarget":[]},"CharacterData":{"EventTarget":[]},"DivElement":{"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"EventTarget":[]},"Node":{"EventTarget":[]},"ParagraphElement":{"EventTarget":[]},"SelectElement":{"EventTarget":[]},"SpanElement":{"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]}}'));
  var string$ = {
...
;
  ...
  (function staticFields() {
    ...
    $.secoes = A._setArrayType(["[1] > Projetos: [Enter para continuar]", "[2] > Munduca: Uma Plataforma de Educa\xe7\xe3o Infantil, meu TCC desenvolvido na ETEC utilizando HTML, CSS, PHP, SQL e JavaScript, link para reposit\xf3rio: https://github.com/Poloyo1/MunducaTCC.git. [Enter para continuar]", "[3] > Sistema de Agenda com chatBot: Um site que tem como objetivo gerenciar agendamentos feitos atrav\xe9s de um bot do WhatsAPP desenvolvido com framework Twilio, JavaScript, PHP e Google API, link para reposit\xf3rio: https://github.com/Poloyo1/Sistema-de-agenda-com-chatBot.git. [Enter para continuar]", "[4] > Forma\xe7\xe3o: [Enter para continuar]", "[5] > Ensino Superior Tecn\xf3logo Curso de An\xe1lise e Desenvolvimento de Sistemas Em Andamento - Fatec de Carapicu\xedba - Conclus\xe3o: dez/26 <br>   > Ensino M\xe9dio T\xe9cnico Curso de Desenvolvimento de Sistemas    > Conclu\xeddo - Etec de Carapicu\xedba - Conclus\xe3o: dez/24 [Enter para continuar]", "[6] > Conhecimentos: [Enter para continuar]", "[7] > Ingl\xeas Intermedi\xe1rio, Leitura e Escrita;    - L\xf3gica de programa\xe7\xe3o e constru\xe7\xe3o de algoritmos;   - Desenvolvimento de sites e softwares;   - Linguagens de Programa\xe7\xe3o (Python, JavaScript, PHP);    - Back e Front-end (MySQL, XAMPP, APIs, HTML e CSS);  - Experi\xeancias de apresenta\xe7\xe3o e exposi\xe7\xe3o de projetos em eventos; [Enter para continuar]"], type$.JSArray_String);
    $.indexAtual = 0;
    $.cursorAtual = null;
  })();
